...
Repository analysis engine for CellFence. It validates cell ownership, public surfaces, declared dependencies, artifact lanes, resource access, baselines, and runtime resource evidence. It also projects per-cell or auto-allocated agent context, coupling graphs, suggested resolutions, and waiver requests so tools can read the allowed fence before editing.
