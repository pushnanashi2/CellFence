...
fs.writeFileSync('src/logger/public.ts', "export function logReport8(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport8 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport8(parsed.tokens.join(\',\'));')}`);
