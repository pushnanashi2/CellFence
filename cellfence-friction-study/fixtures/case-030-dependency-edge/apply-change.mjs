...
fs.writeFileSync('src/logger/public.ts', "export function logReport15(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport15 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport15(parsed.tokens.join(\',\'));')}`);
