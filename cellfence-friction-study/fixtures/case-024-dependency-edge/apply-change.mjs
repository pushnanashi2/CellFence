...
fs.writeFileSync('src/logger/public.ts', "export function logReport9(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport9 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport9(parsed.tokens.join(\',\'));')}`);
