...
fs.writeFileSync('src/logger/public.ts', "export function logReport6(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport6 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport6(parsed.tokens.join(\',\'));')}`);
