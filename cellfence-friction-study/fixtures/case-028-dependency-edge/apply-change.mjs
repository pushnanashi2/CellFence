...
fs.writeFileSync('src/logger/public.ts', "export function logReport13(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport13 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport13(parsed.tokens.join(\',\'));')}`);
