...
fs.writeFileSync('src/logger/public.ts', "export function logReport2(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport2 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport2(parsed.tokens.join(\',\'));')}`);
