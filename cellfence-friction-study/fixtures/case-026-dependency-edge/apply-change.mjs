...
fs.writeFileSync('src/logger/public.ts', "export function logReport11(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport11 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport11(parsed.tokens.join(\',\'));')}`);
