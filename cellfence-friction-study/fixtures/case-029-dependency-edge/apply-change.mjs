...
fs.writeFileSync('src/logger/public.ts', "export function logReport14(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport14 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport14(parsed.tokens.join(\',\'));')}`);
