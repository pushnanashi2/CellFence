...
fs.writeFileSync('src/logger/public.ts', "export function logReport3(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport3 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport3(parsed.tokens.join(\',\'));')}`);
