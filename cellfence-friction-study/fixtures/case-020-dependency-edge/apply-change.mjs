...
fs.writeFileSync('src/logger/public.ts', "export function logReport5(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport5 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport5(parsed.tokens.join(\',\'));')}`);
