...
fs.writeFileSync('src/logger/public.ts', "export function logReport12(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport12 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport12(parsed.tokens.join(\',\'));')}`);
