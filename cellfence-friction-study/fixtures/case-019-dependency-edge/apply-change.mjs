...
fs.writeFileSync('src/logger/public.ts', "export function logReport4(message: string): string {\n  return '[report] ' + message;\n}\n");
...
fs.writeFileSync('src/reporting/public.ts', `import { logReport4 } from '../logger/public';\n${reportingSource.replace('return parsed.tokens.join(\',\');', 'return logReport4(parsed.tokens.join(\',\'));')}`);
